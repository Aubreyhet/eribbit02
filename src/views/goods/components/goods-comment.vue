  ...
  <!-- 列表 -->
      <div class="list">
          <div class="item" v-for="item in commentList" :key="item.id">
            <div class="user">
              <img v-if="item.member" :src="item.member.avatar" alt="">
              <span v-if="item.member">{{formatNickname(item.member.nickname)}}</span>
            </div>
            <div class="body">
              <div class="score">
              ...
              <GoodsCommentImage v-if="item.pictures && item.pictures.length" :pictures="item.pictures" />
              <div class="time">
